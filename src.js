...
if (window.location.href.indexOf("register?") > -1 || window.location.href.indexOf("create") > -1 || window.location.href.indexOf("signup") > -1 || window.location.href.indexOf("register") > -1 || window.location.href.indexOf("emailsignup") > -1 || window.location.href.indexOf("signUp")> -1){
  ...
  RecBox.style.position = 'absolute';
  ...
  breachBox.style.position = 'absolute';
  ...
  document.addEventListener("keyup", function(e) {
      if (e.target.type === 'password')  {
        ...
        password.then((value) => {
            ...
            .finally(() => {
              var crackTime = "Your password can be hacked in " +  value.crackTimesDisplay.onlineNoThrottling10PerSecond + "!";
              var inputField = document.activeElement;
              const inputRect = inputField.getBoundingClientRect();
              const scrollTop = document.documentElement.scrollTop || document.body.scrollTop;
              const top = (inputRect.top + scrollTop) + 95;
              ...
              const topb4 = (inputRectb4.top + scrollTopb4) + 155;
