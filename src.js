...
if (window.location.href.indexOf("create") > -1 || window.location.href.indexOf("signup") > -1 || window.location.href.indexOf("register") > -1 || window.location.href.indexOf("emailsignup") > -1){
  ...
  hackBox.style.top = '-9999px';
  hackBox.style.left = '-9999px';
  ...
  breachBox.style.top = '-9999px';
  breachBox.style.left = '-9999px';
  ...
  document.addEventListener("keyup", function(e) {
    if (e.target.type === 'password')  {
          if ( triggered == 0){
            ...
            const topb2 = (inputRectb2.top + scrollTopb2) - 100;
      ...
      if (e.target.type === 'password')  {
        ...
        password.then((value) => {
            ...
            .finally(() => {
              ...
              const top = (inputRect.top + scrollTop) + 25;
              ...
              const topb3 = (inputRectb3.top + scrollTopb3) + 145;
              ...
              const topb4 = (inputRectb4.top + scrollTopb4) + 85;
              const leftb4 = inputRectb4.right + 105;
              var hackerFactArr = ["With this account, hackers can steal and sell your information!", "With this account, hackers can steal your identitiy!", "With this account, hackers can access any account with the same password!", "With this account, hackers can access your private information! "]
